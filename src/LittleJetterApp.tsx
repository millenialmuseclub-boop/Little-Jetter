...
type ClassicWardrobeAsset = { id: string; type: string; destinations: string[]; canvas: { width: number; height: number } };
const wardrobeAssets = classicWardrobeAssets as ClassicWardrobeAsset[];
